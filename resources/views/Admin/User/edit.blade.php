            ...
            <div class="card-body">
                ...
                <fieldset class="mb-3">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2">{{__('Имя')}}<span
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2">{{__('Фамилия')}}<span
                                class="text-danger">*</span></label>
                        <div class="col-lg-10">
                            <div class="input-group">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2">{{__('Телефон')}}<span
                                class="text-danger">*</span></label>
                        <div class="col-lg-10">
                            <div class="input-group">
                                <input type="text" placeholder="+7(___)-___-__-__"
                                       pattern="\+[7-8][(]\d{3}[)]\d{3}-\d{2}-\d{2}" name="phone" required class="form-control"
